...
namespace zstar{
    ...
    namespace CAD{
        //Default Constructor
        Line::Line() : m_startp(0,0), m_endp(0,0)
        {
            cout<<"Line created"<<endl;
        }
        //Constructor with a start- and end-point.
        Line::Line(const Point &startp, const Point &endp) : m_startp(startp), m_endp(endp)
        {
        ...
        {
            stringstream ss;
            ss<<"Line start point:"<<m_startp.ToString()<<"Line end point:"<<m_endp.ToString()<<endl;
