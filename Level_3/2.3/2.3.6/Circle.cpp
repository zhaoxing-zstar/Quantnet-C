...
using namespace std;
//Default Constructor
Circle::Circle() : m_radius(0.0), m_center_p(0,0)
{
    cout<<"Circle created"<<endl;
}

//Constructor with given radius and centerpoint
Circle::Circle(const double &radius, const Point &center_p) : m_radius(radius), m_center_p(center_p)
{
