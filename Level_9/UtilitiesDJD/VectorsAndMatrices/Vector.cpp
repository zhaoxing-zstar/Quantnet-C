...
#define Vector_CPP
using std::vector;
#include "C:\2021_Spring_Semester\Quantnet_C++\Level_9\UtilitiesDJD\VectorsAndMatrices\Vector.hpp"
...
{ // Unary minus
	...
	// Create new vector of same size and same starting index
	Vector<V, I, S> result((*this).Size(), (*this).MinIndex());
...
{ // Add the elements
	...
	for (I i=this->MinIndex(); i<=this->MaxIndex(); i++) result[i] = (*this)[i] + v[i];
