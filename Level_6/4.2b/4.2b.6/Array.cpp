...
namespace zstar{
    ...
    namespace Containers{
        ...
        */
        ...
        //Initialise this static array size
        template <typename T>           
        int Array<T>::df_size = 0;

        //static funtions to get the default size
        template <typename T>
        ...
        //static funtions to set the default size
        template <typename T>
        void Array<T>::DefaultSize(int df_sz)
        {
            df_size=df_sz;
        }
